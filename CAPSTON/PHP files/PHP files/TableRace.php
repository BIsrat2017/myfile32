        ...
        <div class="formContainer">
          <h3>Add to Table</h3>
            <form method="post" action="?action=add" enctype="multipart/form-data" >
              ...
              <input type="text" placeholder="Race code" required name="t_racecode" id="t_racecode"/></br>    
              <input type="text" placeholder="Race type" required  name="t_racetype" id="t_racetype"/></br>  
             <!--
...
if (isset($_GET['action']))  
    ...
    if ($_GET['action'] == 'add')  
        {  
        /*Insert data.*/  
        $insertSql = "INSERT INTO RACE (racecode, racetype)   
VALUES (?,?,?,?,?)";  
        $params = array(&$_POST['t_racecode'],&$_POST['t_racetype']  
        );  
...
$sql = "SELECT * FROM RACE ORDER BY racecode"; 
...
{ 
  ...
  print("<th>racecode</th>"); 
  print("<th>racetype</th>"); 
  ...
  */ 
  ...
  print("<tbody>");
  print("<tr>"); 
  print("<td><strong>".$row2['racecode']."</strong></td>"); 
  //print("</tr>");
  
  //print("<tr>");
  print("<td>".$row2['racetype']."</td>"); 
  //print("</tr>");
