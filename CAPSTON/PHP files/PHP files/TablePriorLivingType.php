        ...
        <div class="formContainer">
          <h3>Add to Table</h3>
            <form method="post" action="?action=add" enctype="multipart/form-data" >
              ...
              <input type="text" placeholder="prior living ID" required name="t_priorlivingID" id="t_priorlivingID"/></br>    
              <input type="text" placeholder="Prior living" required  name="t_priorliving" id="t_priorliving"/></br>  
              <input type="text" placeholder="Not prior Living" required name="t_notofpriorliving" id="t_notofpriorliving"/></br>  
...
if (isset($_GET['action']))  
    ...
    if ($_GET['action'] == 'add')  
        {  
        /*Insert data.*/  
        $insertSql = "INSERT INTO PriorLivingType (priorlivingID,priorliving,notofpriorliving)   
VALUES (?,?,?)";  
        $params = array(&$_POST['t_priorlivingID'],&$_POST['t_priorliving'], &$_POST['t_notofpriorliving']  
        );  
...
$sql = "SELECT * FROM PriorLivingType ORDER BY priorlivingID"; 
...
{ 
  ...
  print("<th>priorlivingID</th>"); 
  print("<th>PriorLivingType</th>"); 
  print("<th>notofpriorliving</th>"); 
  ...
  print("<tbody>");
  print("<tr>"); 
  print("<td><strong>".$row2['priorlivingID']."</strong></td>"); 
  //print("</tr>");
  ...
  //print("<tr>");
  print("<td>".$row2['notofpriorliving']."</td>"); 
  //print("</tr>");
