        ...
        <div class="formContainer">
          <h3>Add to Table</h3>
            <form method="post" action="?action=add" enctype="multipart/form-data" >
              ...
              <input type="text" placeholder="Is Insured" required name="t_isInsured" id="t_isInsured"/></br>    
		<!--
...
if (isset($_GET['action']))  
    ...
    if ($_GET['action'] == 'add')  
        {  
        /*Insert data.*/  
        $insertSql = "INSERT INTO isInsured (isInsured)   
VALUES (?)";  
        $params = array(&$_POST['t_IisInsured'] 
        );  
...
$sql = "SELECT * FROM isInsured ORDER BY isInsured"; 
...
{ 
  ...
  */ 
  ...
  print("<tbody>");
  print("<tr>"); 
  print("<td><strong>".$row2['isInsured']."</strong></td>"); 
  //print("</tr>");
