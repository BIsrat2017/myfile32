        ...
        <div class="formContainer">
          <h3>Add to Table</h3>
            <form method="post" action="?action=add" enctype="multipart/form-data" >
              <input type="text" placeholder="sexual orientation" required name="t_type" id="t_type"/></br>    
...
if (isset($_GET['action']))  
    ...
    if ($_GET['action'] == 'add')  
        {  
        /*Insert data.*/  
        $insertSql = "INSERT INTO SexOrientation (type)   
VALUES (?)";  
        $params = array(&$_POST['t_type']
        );  
...
$sql = "SELECT * FROM SexOrientation ORDER BY type"; 
...
{ 
  ...
  */
  ...
  print("<tbody>");
  print("<tr>"); 
  print("<td><strong>".$row2['type']."</strong></td>"); 
  //print("</tr>");
