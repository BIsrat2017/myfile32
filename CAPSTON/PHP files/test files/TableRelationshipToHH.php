        ...
        <div class="formContainer">
          <h3>Add to Table</h3>
            <form method="post" action="?action=add" enctype="multipart/form-data" >
              ...
              <input type="text" placeholder="Type of Relationship to HH" required name="t_relationtype" id="t_relationtype"/></br>    
...
if (isset($_GET['action']))  
    ...
    if ($_GET['action'] == 'add')  
        {  
        /*Insert data.*/  
        $insertSql = "INSERT INTO RelationshipToHH (relationtype)   
VALUES (?)";  
        $params = array(&$_POST['t_relationtype']  
        );  
...
$sql = "SELECT * FROM RelationshipToHH ORDER BY relationtype"; 
...
{ 
  ...
  */
  ...
  print("<tbody>");
  print("<tr>"); 
  print("<td><strong>".$row2['relationtype']."</strong></td>"); 
  //print("</tr>");
