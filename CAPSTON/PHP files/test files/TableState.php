        ...
        <div class="formContainer">
          <h3>Add to Table</h3>
            <form method="post" action="?action=add" enctype="multipart/form-data" >
              <input type="text" placeholder="Code" required name="t_statecode" id="t_statecode"/></br>    
              <input type="text" placeholder="State Name" required  name="t_stateName" id="t_stateName"/></br>  
...
if (isset($_GET['action']))  
    ...
    if ($_GET['action'] == 'add')  
        {  
        /*Insert data.*/  
        $insertSql = "INSERT INTO state (statecode,stateName)   
VALUES (?,?)";  
        $params = array(&$_POST['t_statecode'],&$_POST['t_stateName'] 
        );  
        ...
        if ($stmt === false)  
            ...
            if ($errors[0]['code'] == 2601)  
                {  
                echo "The state code you entered has already been used.</br>";  
                }  
...
$sql = "SELECT * FROM state ORDER BY statecode"; 
...
{ 
  ...
  print("<th>statecode</th>"); 
  print("<th>stateName</th>"); 
  ...
  */
  ...
  print("<tbody>");
  print("<tr>"); 
  print("<td><strong>".$row2['statecode']."</strong></td>"); 
  //print("</tr>");
  
  //print("<tr>");
  print("<td>".$row2['stateName']."</td>"); 
  //print("</tr>");
