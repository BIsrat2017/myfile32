        ...
        <div class="formContainer">
          <h3>Add to Table</h3>
            <form method="post" action="?action=add" enctype="multipart/form-data" >
              ...
              <input type="text" placeholder="Living ID" required name="t_livingID" id="t_livingID"/></br>   
              <input type="text" placeholder="Prior Living Type" required  name="t_priorLivingtype" id="t_priorLivingtype"/></br>  
              
              <input type="text" placeholder="From date" required name="t_startdate" id="t_startdate"/></br>  
              <input type="text" placeholder="Up-to date"  required name="t_enddate" id="t_enddate"/></br>  
              <input type="text" placeholder="householdId" required name="t_householdId" id="t_householdId"/></br>  
...
if (isset($_GET['action']))  
    ...
    if ($_GET['action'] == 'add')  
        {  
        /*Insert data.*/  
        $insertSql = "INSERT INTO PriorLiving (livingID, priorLivingtype, startdate, enddate, householdId)   
VALUES (?,?,?,?,?)";  
        $params = array(&$_POST['t_livingID'],&$_POST['t_priorLivingtype'], &$_POST['t_startdate'], &$_POST['t_enddate'], &$_POST['t_householdId']  
        );  
...
$sql = "SELECT * FROM PriorLiving ORDER BY ename"; 
...
{ 
  ...
  print("<th>livingID</th>"); 
  print("<th>priorLivingtype</th>");
  print("<th>startdate</th>"); 
  print("<th>enddate</th>"); 
  ...
  print("<tbody>");
  print("<tr>"); 
  print("<td><strong>".$row2['livingID']."</strong></td>"); 
  //print("</tr>");
  
  //print("<tr>");
  print("<td>".$row2['priorLivingtype']."</td>"); 
  //print("</tr>");

  //print("<tr>");
  print("<td>".$row2['startdate']."</td>"); 
  //print("</tr>");

  //print("<tr>");
  print("<td>".$row2['enddate']."</td>");
  //print("</tr>");
