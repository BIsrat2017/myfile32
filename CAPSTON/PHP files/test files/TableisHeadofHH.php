        ...
        <div class="formContainer">
          <h3>Add to Table</h3>
            <form method="post" action="?action=add" enctype="multipart/form-data" >
              ...
              <input type="text" placeholder="Head of House Hold" required name="t_isHeadofHH" id="t_isHeadofHH"/></br>    
...
if (isset($_GET['action']))  
    ...
    if ($_GET['action'] == 'add')  
        {  
        /*Insert data.*/  
        $insertSql = "INSERT INTO isHeadofHH (isHeadOfHH)   
VALUES (?)";  
        $params = array(&$_POST['t_isHeadofHH']  
        );  
...
$sql = "SELECT * FROM isHeadofHH ORDER BY isHeadOfHH"; 
...
{ 
  ...
  */
  ...
  print("<tbody>");
  print("<tr>"); 
  print("<td><strong>".$row2['isHeadOfHH']."</strong></td>"); 
  //print("</tr>");
